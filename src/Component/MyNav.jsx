    ...
    return (
      <>
        <nav
          ...
          style={{ backgroundColor: "rgba(20,20,20,255)" }}
        >
          <div className="container-fluid">
            ...
            <button
              ...
              data-bs-target="www.google.itnavbarSupportedContent"
            ...
            >
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <Link to="/" className={location.pathname==="/" ? "nav-link text-danger" : "nav-link text-light"}>
                      Tv Shows
                  </Link>
                </li>
              ...
              <ul className="navbar-nav ">
                ...
                <a href="www.google.it" className="text-light nav-link"></a>
              </ul>
            </div>
          </div>
        </nav>
